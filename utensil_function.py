...
class restart_thread(threading.Thread):
    ...
    def run(self):
        ...
        with warnings.catch_warnings():
            ...
            if get_weibo(self.name,self.max_id):
...
def restart():
    ...
    for name in result:
        ...
        max_id = cur.fetchall()
        new_start = restart_thread(name[0],max_id[0][0]-1)
        new_start.start()
